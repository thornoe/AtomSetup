...
-   As suggested [here](https://saturncloud.io/blog/the-right-way-to-update-anaconda-and-conda-base-environments), update to the latest compatible versions of [Anaconda](https://docs.anaconda.com/free/anaconda/reference/release-notes), [Conda](https://docs.conda.io/projects/conda/en/stable/release-notes.html), [Python](https://www.python.org/downloads/windows), and related packages as often as possible by running `conda update anaconda`, `conda update conda`, `conda update --all` and `pip_upgrade_outdated` (install [this tool](https://pypi.org/project/pip-upgrade-outdated) first: `pip install pip_upgrade_outdated`).
